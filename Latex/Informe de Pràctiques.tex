...
Per la simulació del condensador planoparal·lel, considerem la distribució representada com la suma de 200 càrregues puntuals (pel fil de l'esquerra de valor $-q$ i pel fil de la dreta $q$) distribuïdes uniformement en les plaques: una es troba a $x = d/2$, i l'altre a $x = - d/2$. En l'eix de les y, les càrregues van des de $y = -H/2$ fins $y = H/2$. Per a cada una de les càrregues, calculem la seva contribució al potencial i al camp elèctric en tots els punts de la malla $(X, Y)$ usant el principi de superposició.
