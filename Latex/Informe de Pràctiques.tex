...
\begin{eqnarray*}
	\omega_{1,2} = \frac{\text{R}}{2\text{L}} \pm \frac{\sqrt{\left(\frac{\text{R}}{\text{L}}\right)^2 + 4\omega_0^2}}{2}\\
\end{eqnarray*}
...
\begin{table}[h]
	...
	\begin{tabular}{lccccc}
		\toprule
		& $f_0$ & $f_1$ & $f_2$ & $\abs{T_R(\omega_0)}$ & $\abs{T_R(\omega_{1,2})}$ \\ 
		\midrule
		$\mathbf{R = 2660\Omega}$ & 8761\text{Hz} & 3391\text{Hz} & 22634\text{Hz} & 1 & $1/\sqrt{2}$\\ 
		$\mathbf{R = 274\Omega}$ & 8761\text{Hz} & 7826\text{Hz} & 9808\text{Hz} & 1 & $1/\sqrt{2}$ \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lcccccc}
		\toprule
		& $f_0$ & $f_1$ & $f_2$ & $\abs{T_R(\omega_0)}$ & $\abs{T_R(\omega_{1})}$ & $\abs{T_R(\omega_{2})}$ \\ 
		\midrule
		$\mathbf{R = 2660\Omega}$ & 8960\text{Hz} & 2860\text{Hz} & 23460\text{Hz} & 1 & 0.72340 & 0.72340\\ 
		$\mathbf{R = 274\Omega}$ & 8860\text{Hz} & 8040\text{Hz} & 9830\text{Hz} & 0.87647 & 0.70588 & 0.88235\\
		\bottomrule
	\end{tabular}
\end{table}
