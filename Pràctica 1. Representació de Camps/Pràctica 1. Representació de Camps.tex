...
\left.
\begin{array}{c}
	\oint \vec{E} \cdot d\vec{S} = E 2\pi \rho L \\[10pt]
	\frac{Q_{int}}{\epsilon_0} = \frac{1}{\epsilon_0} \int \lambda \, dl = \frac{\lambda}{\epsilon_0} L
\end{array}
\right\}
\quad \Rightarrow \quad 
\vec{E} = \frac{\lambda}{2\pi \epsilon_0} \frac{1}{\rho} \vec{e}_{\rho}
\]
